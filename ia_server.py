...
class HaloInterfaceStreaming(ctk.CTk):
    def __init__(self):
        ...
        self.is_processing = False  # ← Protección contra múltiples respuestas
        ...
        self.crear_globo_fijo("Estación base activada. ¿En qué te ayudo hoy, controlador?", de_usuario=False)
